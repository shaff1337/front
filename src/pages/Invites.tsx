...
import { getInvites, getInvitesPages } from '../api/user';
...
function Invites(): JSX.Element {
	...
	return (
		<>
			<PageTitle.Container>
				<PageTitle.Body title="Invites List" description="See your invites here." />
			</PageTitle.Container>
						...
						<Table.Tbody>
							{data.map((invite: any) => (
								<Table.Tr key={invite.id}>
									...
									{/* <Table.Td>{invite.invitedUser}</Table.Td> */}
